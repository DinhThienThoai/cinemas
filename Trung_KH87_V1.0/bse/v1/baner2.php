<div class="home">
		<div class="home__carousel owl-carousel" id="flixtv-hero">
			<div class="home__card">
				<a href="">
					<img src="img/category/7a.jpg" alt="">
				</a>
				<div>
					<h2>American Idol</h2>
					<ul>
			...
			<div class="home__card">
				<a href="">
					<img src="img/category/1a.jpg" alt="">
				</a>
				<div>
					<h2>AMAZING RACE</h2>
					<ul>
			...
			<div class="home__card">
				<a href="">
					<img src="img/category/2a.jpg" alt="">
				</a>
				<div>
					<h2> WEEKY IDOL</h2>
					<ul>
			...
			<div class="home__card">
				<a href="">
					<img src="img/category/3a.jpg" alt="">
				</a>
				<div>
					<h2>SO YOU THING YOU DANCE</h2>
					<ul>
						<li>Free</li>
						<li>Documentary</li>
						<li>2017</li>
			...
			<div class="home__card">
				<a href="">
					<img src="img/category/4a.jpg" alt="">
				</a>
				<div>
					<h2>2 DAY 1 NIGHT</h2>
					<ul>
			...
			<div class="home__card">
				<a href="">
					<img src="img/category/5a.jpg" alt="">
				</a>
				<div>
					<h2>X - FACTOR</h2>
					<ul>
			...
			<div class="home__card">
				<a href="">
					<img src="img/category/6a.jpg" alt="">
				</a>
				<div>
					<h2>Bad Impulse</h2>
					<ul>
			...
			<div class="home__card">
				<a href="">
					<img src="img/category/8a.jpg" alt="">
				</a>
				<div>
					<h2>Tenet</h2>
					<ul>
