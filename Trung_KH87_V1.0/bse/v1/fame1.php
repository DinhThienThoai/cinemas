<section class="section">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h2 class="section__title"><b>SỰ KIỆN ĐẶC BIỆT </b>trong tuần qua</h2>
					<h2 class="section__title">Gặp gỡ người nổi tiếng và câu chuyện thú vị</h2>
				</div>
					...
					<div class="section__carousel-wrap">
						<div class="section__interview owl-carousel" id="flixtv">
							<div class="interview">
								...
								<h3 class="interview__title"><a ">Jisso</a></h3>
							</div>
							...
							<div class="interview">
								...
								<h3 class="interview__title"><a ">Thành Trung - anhnhanvienmayman</a></h3>
							</div>

							<div class="interview">
								<a " class="interview__cover">
									<img src="img/interview/8.jpg" alt="">
									<span>
								...
								<h3 class="interview__title"><a ">Scarlet Witch</a></h3>
							</div>
							...
							<div class="interview">
								...
								<h3 class="interview__title"><a ">MTP - Sơn Tùng	</a></h3>
							</div>
							...
							<div class="interview">
								...
								<h3 class="interview__title"><a ">Cristianno Ronaldo</a></h3>
							</div>
							...
							<div class="interview">
								...
								<h3 class="interview__title"><a ">Henry Cavill</a></h3>
							</div>
						</div>
