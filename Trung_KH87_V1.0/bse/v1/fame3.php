<section class="section">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h2 class="section__title"><b>B X H    </b>   Phim được xem nhiều nhất</h2>
					<p class="section__text">Bảng xếp hạng được đánh giá bởi người xem</p>
				</div>
				...
				<div class="col-12">
					<div class="section__carousel-wrap">
						<div class="section__interview owl-carousel" id="flixtv">
							<div class="interview">
								<a detail.php class="interview__cover">
									<img src="img/interview/1a.jpg" alt="">
									<span>
								...
								<h3 class="interview__title"><a detail.php>What Was Ben Affleck Planning for His Unmade 'Batman' Film?</a></h3>
							</div>

							<div class="interview">
								<a detail.php class="interview__cover">
									<img src="img/interview/2a.jpg" alt="">
									<span>
								...
								<h3 class="interview__title"><a detail.php>A Guide to the Work of Ryan Murphy</a></h3>
							</div>

							<div class="interview">
								<a detail.php class="interview__cover">
									<img src="img/interview/3a.jpg" alt="">
									<span>
								...
								<h3 class="interview__title"><a detail.php>Gugu Mbatha-Raw Shares the Films That Give Her Hope</a></h3>
							</div>

							<div class="interview">
								<a detail.php class="interview__cover">
									<img src="img/interview/4a.jpg" alt="">
									<span>
								...
								<h3 class="interview__title"><a detail.php>Best of 2020: Top Trending Moments</a></h3>
							</div>

							<div class="interview">
								<a detail.php class="interview__cover">
									<img src="img/interview/5a.jpg" alt="">
									<span>
								...
								<h3 class="interview__title"><a detail.php>How Movies and TV Shaped Our Perception of HIV/AIDS</a></h3>
							</div>
							...
							<div class="interview">
								...
								<h3 class="interview__title"><a detail.php>American Gods</a></h3>
							</div>
						</div>
