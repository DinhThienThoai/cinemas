...
<body>
	...
	<section class="section section--head section--head-fixed section--gradient section--details-bg">
		<div class="section__bg" data-bg="img/card/dt1.jpg"></div>
		<div class="container">
			<!-- article -->
			<div class="article">
				<div class="row">
					...
					<div class="col-12 col-xl-10">
							...
							<iframe controls crossorigin playsinline poster="./img/card/dt1.jpg" id="player" width="900" height="540" src="https://www.youtube.com/embed/Zj4Y9QQ9sME" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
