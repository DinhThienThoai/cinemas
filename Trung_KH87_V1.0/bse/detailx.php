...
<body>
	...
	<section class="section section--head section--head-fixed section--gradient section--details-bg">
		<div class="section__bg" data-bg="img/card/anh3.jpg"></div>
		<div class="container">
			<!-- article -->
			<div class="article">
				<div class="row">
					<div class="col-12 col-xl-8">
						<!-- trailer -->
						<a href="https://www.youtube.com/watch?v=6E_VkgydZsw" class="article__trailer open-video">
						...
						<div class="article__content">
							...
							<p>a page when looking at it it has aetters, as opposed to using 'Content here, content here', making it look like readable English.</p>
						</div>
						<!-- end article content -->
					</div>
					...
					<div class="col-12 col-xl-10">
							...
							<iframe controls crossorigin playsinline poster="./img/card/anh2.jpg" id="player" width="900" height="540" src="https://www.youtube.com/embed/LoyyQOAggYQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	...
	<section class="section">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h2 class="section__title"><a href="category.html">Dành cho bạn </a></h2>
				</div>
...
<!-- Mirrored from dmitryvolkov.me/demo/flixtv/main/details3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Nov 2021 05:52:47 GMT -->
</html>