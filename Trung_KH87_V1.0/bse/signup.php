...
<!-- Mirrored from dmitryvolkov.me/demo/flixtv/main/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Nov 2021 05:53:02 GMT -->
<head>
	<meta charset="utf-8">
					...
					<div class="sign__content">
						...
						<form action="#" class="sign__form">
							...
							<div class="sign__group sign__group--checkbox">
								...
								<label for="remember">Bạn đồng ý với điều khoản <a href="privacy.html">của chúng tôi </a></label>
							</div>
							
							<button  class="sign__btn" type="button"> <a href="signin.php">Đăng ký !1!</a></button>
							...
							<span class="sign__text">Bạn đã có tài khoản <a href="signin.php">Đăng nhập!</a></span>
						</form>
						<!-- registration form -->
					</div>
				</div>
